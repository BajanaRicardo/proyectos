                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form id="frmLogin">
                                            ...
                                            <div class="form-group">
                                                <label class="small mt-4" for="clave"><i class="fas fa-key"></i> Contraseña</label>
                                                <input class="form-control py-3" id="clave" name="clave" type="password" placeholder="Escriba su contraseña" />
                                            </div>
